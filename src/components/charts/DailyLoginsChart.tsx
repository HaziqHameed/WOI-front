  ...
  return (
    <div className="flex items-center justify-center w-full">
      <div className="relative flex flex-col items-start p-0 gap-1 w-full">
        <div className="w-full h-[280px] sm:h-[329px] relative max-w-[900px] overflow-x-auto">
          <div className="absolute w-full h-full left-0 top-0 bg-[#111827] rounded-2xl"></div>

          <div className="absolute w-[45px] sm:w-[57.3px] h-[20px] sm:h-[27.5px] left-[8px] sm:left-[11.5px] top-[50%] -translate-y-1/2 -rotate-90 text-white font-normal text-[14px] sm:text-[18.3px] leading-[20px] sm:leading-[27.5px] origin-center">
            Logins
          </div>
          ...
          <div className="absolute w-[82.5%] h-[20px] sm:h-[27.5px] left-[9.8%] top-[15%] sm:top-[71.11px]">
          ...
          <div className="absolute w-[82.5%] h-[20px] sm:h-[27.5px] left-[9.8%] top-[35%] sm:top-[130.79px]">
          ...
          <div className="absolute w-[82%] h-[20px] sm:h-[27.5px] left-[10.3%] top-[55%] sm:top-[204.24px]">
          ...
          <div className="absolute w-[81.3%] h-[20px] sm:h-[27.5px] left-[10.9%] top-[75%] sm:top-[252.55px]">
