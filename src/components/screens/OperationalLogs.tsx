    ...
    <>
      ...
      <div className="w-full">
        ...
        <div className="hidden md:block overflow-x-auto">
          <div className="min-w-[800px] lg:min-w-[1318px] rounded-xl overflow-hidden">
            {/* Column Headers */}
              ...
              {logs.map((log, index) => (
                <div key={index} className="bg-[#111827] px-8 py-3.5 flex items-center">
                  <div className="flex items-center gap-1">
                    <span className="text-white text-sm font-medium w-[133px]">{log.timestamp}</span>
                  </div>
                  ...
                  <div className="flex items-center gap-1">
                    <span className="text-white text-sm font-medium w-[105px] ml-42">{log.service}</span>
                  </div>
                  <div className="w-88 ml-24">
                    <span className="text-white text-sm font-medium flex-1">{log.message}</span>
                  </div>
                  <div className="flex items-center gap-1 ml-auto mr-40">
                    <span className="text-white text-sm font-medium w-[77px]">{log.userId}</span>
