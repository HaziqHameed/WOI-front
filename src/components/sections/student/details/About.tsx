...
import { details, socialLinksData } from '@/data/student/CompanyDetails';
...
export function About() {
  return (
    <>
      ...
      />
      <SocialLinksManager<SocialLink>
        title='Social'
        addButtonText='Add'
        initialLinks={socialLinksData}
        onLinksChange={(links) => console.log('Links changed:', links)}
        onSave={async () => {
          console.log('saved');
        }}
        icon={userIcon}
