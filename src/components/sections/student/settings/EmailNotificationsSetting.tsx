...
export default function EmailNotificationsSettings() {
  ...
  const [linkedinUrl, setLinkedinUrl] = useState('X_AE_A-22');

  return (
    <div className="w-full mx-auto mt-5">
      {/* Main Container */}
      <div className="bg-[#111827] rounded-[3px] p-6 md:p-8">
        {/* Header */}
        <h1 className="text-[11px] font-bold uppercase tracking-wide mb-6 md:mb-8 font-['Poppins']">
          EMAIL NOTIFICATIONS
        </h1>

        {/* Notification Summary Section */}
        <div className="border border-white rounded-[3px] p-5 md:p-6 mb-8 md:mb-12">
          <h2 className="text-[13px] font-bold mb-3 font-['Poppins']">
            Notification Summary
          </h2>
          <p className="text-[13px] font-normal leading-[17px] mb-6 font-['Poppins']">
            ...
            <label className="flex items-center gap-2 cursor-pointer">
              <div className="relative">
                <input
                  ...
                  onChange={() => setSummaryEnabled(true)}
                  className="sr-only"
                />
                <div className={`w-[14px] h-[14px] rounded-full border border-white ${summaryEnabled
                    ? 'bg-gradient-to-b from-[#FFFFFF] to-[#F4F4F4] shadow-[inset_0px_1px_0px_#ECECEC]'
                    : 'bg-white shadow-[inset_0px_1px_0px_#ECECEC]'
                  }`}>
                  {summaryEnabled && (
                    <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-2 h-2 bg-gradient-to-b from-[#3CA7FC] to-[#2F74E2] rounded-[4px]"></div>
                  )}
                </div>
              </div>
              <span className="text-[12px] font-normal leading-[14px] font-['Poppins']">
                On
              </span>
            </label>
            ...
            <label className="flex items-center gap-2 cursor-pointer">
              <div className="relative">
                <input
                  ...
                  name="summary"
                  checked={!summaryEnabled}
                  onChange={() => setSummaryEnabled(false)}
                  className="sr-only"
                />
                <div className={`w-[14px] h-[14px] rounded-full border border-white ${!summaryEnabled
                    ? 'bg-white shadow-[inset_0px_1px_0px_#ECECEC]'
        ...
        <div className="border-b border-white pb-6 md:pb-8 mb-8 md:mb-12">
          <h2 className="text-[14px] font-bold leading-[18px] mb-4 font-['Poppins']">
            Network Activity <span className="font-normal italic">Email me a summary of:</span>
          </h2>
          ...
          <label className="flex items-center gap-3 cursor-pointer">
            <div className="relative">
              <input
                ...
                className="sr-only"
              />
              <div className={`w-[14px] h-[14px] rounded-[3px] border border-white ${networkActivity
                  ? 'bg-gradient-to-b from-[#FFFFFF] to-[#F4F4F4] shadow-[inset_0px_1px_0px_#ECECEC]'
                  : 'bg-gradient-to-b from-[#FFFFFF] to-[#F4F4F4] shadow-[inset_0px_1px_0px_#ECECEC]'
                }`}>
                {networkActivity && (
            ...
            <span className="text-[13px] font-normal leading-[14px] font-['Poppins']">
        ...
        <div className="mb-8 md:mb-12">
          ...
          <div className="flex flex-col flex-row items-stretch sm:items-center max-w-[520px]">
            <div className="flex items-center bg-[#1E2839] border border-[#CBD5E1] rounded-l-full sm:rounded-l-full rounded-r-full sm:rounded-r-none border-r sm:border-r-[#CBD5E1] px-3 h-12 min-w-[90px]">
              <span className="text-base font-medium leading-[22px] tracking-[-0.007em] font-['Poppins'] whitespace-nowrap">
                LinkedIn
              </span>
            </div>
            <div className="flex-1 bg-[#1E2839] border border-[#CBD5E1] border-t-0 sm:border-t sm:border-l-0 rounded-l-full sm:rounded-l-none rounded-r-full sm:rounded-r-full px-3 h-12 flex items-center mt-[-1px] sm:mt-0">
              <input
                ...
                className="w-full bg-transparent text-base font-medium leading-[22px] tracking-[-0.007em] font-['Poppins'] text-white outline-none border-none"
