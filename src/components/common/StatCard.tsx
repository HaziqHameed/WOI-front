...
export default function StatCard({ stat }: StatCardProps) {
  return (
    ...
    >
      {/* Info Icon */}
      <div className="absolute h-10 w-10 sm:h-12 sm:w-12 -right-6 sm:-right-8 top-1 z-10">
        <svg
          width="12"
          height="12"
          viewBox="0 0 12 12"
      ...
      {/* Content */}
      <div className="relative flex flex-col items-start p-3 sm:p-4 gap-2 w-full h-full box-border">
