        ...
        <div className="relative w-full h-full">
          ...
          >
            <button
              ...
              } py-[9px] rounded-lg border border-[#CE2D52] bg-gradient-to-l from-[rgba(206,45,82,0.05)] to-[rgba(206,45,82,0.2)] hover:opacity-80 transition-opacity`}
              aria-current="page"
            >
              <svg
                width={24}
              ...
              {!isCollapsed && (
                <span className="text-[16px] leading-[24px] font-poppins text-[#CE2D52] whitespace-nowrap">
                  Home
                </span>
              )}
            </button>
            ...
            <button
              ...
              } py-[9px] rounded-lg hover:bg-white/5 transition-colors`}
            >
              <svg
                width="24"
                height="25"
              ...
              {!isCollapsed && (
                <span className="text-[16px] leading-[24px] font-poppins text-white whitespace-nowrap overflow-hidden text-ellipsis">
            ...
            >
              ...
              {!isCollapsed && (
                <span className="text-[16px] leading-[24px] font-poppins text-white whitespace-nowrap">
                  Master Data
                </span>
              )}
            </button>
