...
export const tabs = [
  ...
  export const UserManagementTableColumns: LogsTableColumn[] = [
    ...
    { 
      ...
      sortable: false,
      width: '',
      className: 'flex items-center gap-1 ml-[195px]',
      render: (value, row) => (
        <div className="flex items-center w-[68px]">
          <span className={`${row.levelColor} px-2 py-1 rounded-md text-sm font-medium w-fit ml-[83px]`}>
            {String(value)}
          </span>
        </div>
      )
    ...
    { 
      ...
      sortable: false,
      width: '',
      className: 'flex items-center gap-1 ml-[225px]', 
      render: (value) => (
        <div className="flex items-center gap-1">
          <span className="text-white text-sm font-medium w-[105px] ml-42">{String(value)}</span>
        </div>
      )
    },
    { 
