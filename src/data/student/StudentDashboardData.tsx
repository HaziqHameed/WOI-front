        ...
        icon: (
            <div className="relative w-[27.19px] h-[27.19px] rounded-full bg-white flex items-center justify-center">
                <svg width="22" height="22" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg" >
                    <path fillRule="evenodd" clipRule="evenodd" d="M11.1133 10.8039C11.1133 9.32224 12.3144 8.12109 13.7961 8.12109C15.2778 8.12109 16.4789 9.32224 16.4789 10.8039C16.4789 12.2856 15.2778 13.4867 13.7961 13.4867C12.3144 13.4867 11.1133 12.2856 11.1133 10.8039Z" fill="#1ABCFE" />
                    <path fillRule="evenodd" clipRule="evenodd" d="M5.75 16.1692C5.75 14.6875 6.95114 13.4863 8.43283 13.4863H11.1157V16.1692C11.1157 17.6508 9.91451 18.852 8.43283 18.852C6.95114 18.852 5.75 17.6508 5.75 16.1692Z" fill="#0ACF83" />
                    <path fillRule="evenodd" clipRule="evenodd" d="M11.1133 2.75586V8.12151H13.7961C15.2778 8.12151 16.4789 6.92037 16.4789 5.43869C16.4789 3.957 15.2778 2.75586 13.7961 2.75586H11.1133Z" fill="#FF7262" />
                    <path fillRule="evenodd" clipRule="evenodd" d="M5.75 5.43869C5.75 6.92037 6.95114 8.12151 8.43283 8.12151H11.1157V2.75586H8.43283C6.95114 2.75586 5.75 3.957 5.75 5.43869Z" fill="#F24E1E" />
                    <path fillRule="evenodd" clipRule="evenodd" d="M5.75 10.8039C5.75 12.2856 6.95114 13.4867 8.43283 13.4867H11.1157V8.12109H8.43283C6.95114 8.12109 5.75 9.32224 5.75 10.8039Z" fill="#A259FF" />
                </svg>
